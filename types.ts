...
/**
 * The accepted values for a highlight modication action.
 */

export type HighlightModication = {
  type: "Add" | "Delete" | "Edit" | "Clear";
  highlight?: Highlight | ViewportHighlight;
};

/**
 * Props for updateHighlights function used to update highlights external to the annotator component
 */
export type UpdateHighlights = (
  highlights: CommentedHighlight[],
  modification?: HighlightModication
) => void;
